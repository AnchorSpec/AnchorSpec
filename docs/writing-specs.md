...
You rarely write a spec from a blank page. You describe a change in plain language, `/ansx:propose` drafts the requirements and scenarios, and then you make them good. This page is about that last part — what "good" looks like, and how to steer the AI toward it.
...
- **The right strength.** AnchorSpec uses the RFC 2119 keywords, and they mean different things:
...
Because `/ansx:propose` does the first draft, the quality of what you get back tracks the quality of what you give it. You don't have to write requirements by hand — you have to aim the AI well:
